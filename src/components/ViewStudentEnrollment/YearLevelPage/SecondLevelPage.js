...
import SecondYearFirstSem from "./yearStatus/SecondYearSubs/SecondYearFirstSem"
import SecondYearSecondSem from "./yearStatus/SecondYearSubs/SecondYearSecondSem"
...
function YearLevelPage({onClickBack, onClickNext, title}) {
  ...
  return (
        ...
        <div style={{ backgroundColor: "#F6F6F6", height: "100%", width:"100%", display:"flex", position:"absolute"}}>
              {show4FirstSem ? (
                    <SecondYearFirstSem onClickBack={()=> setShow4FirstSem(!show4FirstSem) & setShowYearLevelPage(!showYearLevelPage)}></SecondYearFirstSem>
                  ) : null}

              {show4SecondSem ? (
                    <SecondYearSecondSem  onClickBack={()=> setShow4SecondSem(!show4SecondSem) & setShowYearLevelPage(!showYearLevelPage)}></SecondYearSecondSem>
                  ) : null}
