...
function FirstLevelPage({onClickBack, onClickNext, title}) {
  ...
  return (
        ...
        <div style={{ backgroundColor: "#F6F6F6", height: "100%", width:"100%", display:"flex", position:"absolute"}}>
              ...
              {show4FirstSem ? (
                    <><h1>FIRST YEAR: FIRST SEM SUBJECTS</h1>
                    <FirstYearFirstSem onClickBack={() => setShow4FirstSem(!show4FirstSem) & setShowYearLevelPage(!showYearLevelPage)} onClickNext={() => setShowConfrm(!showConfrm) & setShow4FirstSem(!show4FirstSem)}></FirstYearFirstSem></>
                  ) : null}

              {show4SecondSem ? (
                    <><h1>SECOND YEAR: SECOND SEM SUBJECTS</h1>
                    <FirstYearSecondSem onClickBack={() => setShow4SecondSem(!setShow4SecondSem) & setShowYearLevelPage(!showYearLevelPage)} onClickNext={() => setShowConfrm(!showConfrm) & setShow4SecondSem(!show4SecondSem)}></FirstYearSecondSem></>
                  ) : null}
