...
<<<<<<<< HEAD:src/components/yearStatus/ThirdYearSubs/Component/ITElect2Prof.js
function ITElect2({onClickBack, onClickNext, title}) {
========
function ITElective2({onClickBack, onClickNext, title}) {
>>>>>>>> 5c76616bd4569a12c5f74b01333bbf371aff76a0:src/components/yearStatus/ThirdYearSubs/Component/ITElective2Prof.js
...
========
              <div style={{marginLeft: "-10rem", marginTop: "-5rem"}}>
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: IT325 - ITElective2</h4>
>>>>>>>> 5c76616bd4569a12c5f74b01333bbf371aff76a0:src/components/yearStatus/ThirdYearSubs/Component/ITElective2Prof.js
              </div>              
             </div>
