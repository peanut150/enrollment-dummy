...
<<<<<<<< HEAD:src/components/yearStatus/FirstYearSubs/Component/PE1Prof.js
function PE1({onClickBack, onClickNext, title}) {
========
function MobileProgramming({onClick, title}) {
>>>>>>>> 5c76616bd4569a12c5f74b01333bbf371aff76a0:src/components/yearStatus/ThirdYearSubs/Component/MobileProgrammingProf.js
...
<<<<<<<< HEAD:src/components/yearStatus/FirstYearSubs/Component/PE1Prof.js
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: PE101d - Physical Activity Towards Health and Fitness 1</h4>
========
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: IT313 - MobileProgramming</h4>
>>>>>>>> 5c76616bd4569a12c5f74b01333bbf371aff76a0:src/components/yearStatus/ThirdYearSubs/Component/MobileProgrammingProf.js
              </div>              
             </div>
...
========
                    <h1 style={{fontSize: 25, fontWeight:"normal"}}>Instructor 1: Mr. Dario C. Meñoza Jr.</h1>
                </div>
