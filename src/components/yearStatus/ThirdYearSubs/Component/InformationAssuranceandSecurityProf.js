...
function InformationAssuranceandSecurity({onClickBack, onClickNext, title}) {
        ...
        <div style={{ backgroundColor: "#F6F6F6", height: "100%", width:"100%", display:"flex", position:"absolute"}}>
             <div style=
              ...
              <div style={{marginLeft: "-10rem", marginTop: "-5rem"}}>
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: IT311 - InformationAssuranceandSecurity</h4>
              </div>              
             </div>
             ...
             <div>
                ...
                <div style={{marginTop:"-6rem"}}>
                    ...
                    <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                        ...
                        <CheckBox value="TH 2:30PM-4:30PM" title="TH 2:30PM-4:30PM"></CheckBox>
...
export default InformationAssuranceandSecurity;