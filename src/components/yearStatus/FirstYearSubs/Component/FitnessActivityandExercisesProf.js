...
function FitnessActivityandExercises({onClickBack, onClickNext, title}) {
        ...
        <div style={{ backgroundColor: "#F6F6F6", height: "100%", width:"100%", display:"flex", position:"absolute"}}>
             <div style=
              ...
              <div style={{marginLeft: "-10rem", marginTop: "-5rem"}}>
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: PATH FIT 2 - Fitness Activity and Exercises</h4>
              </div>              
             </div>
             ...
             <div>
                ...
                <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                    <CheckBox value="W 8:00AM-9:30AM" title="W 8:00AM-9:30AM"></CheckBox>
                    <CheckBox value="TH 1:00PM-2:30PM" title="TH 1:00PM-2:30PM"></CheckBox>
                    <CheckBox value="F 11:00AM-12:30PM" title="F 11:00AM-12:30PM"></CheckBox>
                </div>
                ...
                <div style={{marginTop:"-6rem"}}>
                    ...
                    >
                        <h1 style={{fontSize: 25, fontWeight:"normal"}}>Instructor 2: Ms. Genda Hue</h1>
                    </div>
                    
                    <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                        <CheckBox value="M 1:00PM-2:30PM" title="M 1:00PM-2:30PM"></CheckBox>
                        <CheckBox value="T 5:00PM-6:30PM" title="T 5:00PM-6:30PM"></CheckBox>
                        <CheckBox value="W 12:00PM-1:30PM" title="W 12:00PM-1:30PM"></CheckBox>
                    </div>
...
export default FitnessActivityandExercises;