...
function TheContemporaryWorld({onClick, title}) {
        ...
        <div style={{ backgroundColor: "#F6F6F6", height: "100%", width:"100%", display:"flex", position:"absolute"}}>
             <div style=
              ...
              <div style={{marginLeft: "-10rem", marginTop: "-5rem"}}>
                <h4 style={{fontWeight:"bold", fontSize: 30}}>SUBJECT: SS103 - The Contemporary World</h4>
              </div>              
             </div>
             ...
             <div>
                ...
                >
                    <h1 style={{fontSize: 25, fontWeight:"normal"}}>Instructor 1: Mrs. Golda S. Sierra</h1>
                </div>
                
                <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                    <CheckBox value="M 9:00AM-10:30AM" title="M 9:00AM-10:30AM"></CheckBox>
                    <CheckBox value="W 3:00PM-4:30PM" title="W 3:00PM-4:30PM"></CheckBox>
                ...
                <div style={{marginTop:"-6rem"}}>
                    ...
                    >
                        <h1 style={{fontSize: 25, fontWeight:"normal"}}>Instructor 2: Mrs. Jamie Cruz</h1>
                    </div>
                    
                    <div style={{marginTop: "1rem", marginLeft:"40rem"}}>
                        <CheckBox value="T 11:00AM-12:30PM" title="T 11:00AM-12:30PM"></CheckBox>
...
export default TheContemporaryWorld;